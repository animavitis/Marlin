...
// #define Z_STEPPER_AUTO_ALIGN
  ...
  // #define Z_STEPPER_ALIGN_XY { {  50, 150 }, { 220,  150 } }
  ...
  #define G34_MAX_GRADE              5    // (%) Maximum incline that G34 will handleG34
...
//#define LCD_SHOW_E_TOTAL
  ...
  #define POWER_LOSS_RECOVERY
    ...
    #define POWER_LOSS_PIN         -1 // Pin to detect power loss
...
#define FWRETRACT
  ...
  #define FWRETRACT_AUTORETRACT           // Override slicer retractions
    ...
    #define MAX_AUTORETRACT 50.0          // (mm) Don't convert E moves over this length
  #endif
